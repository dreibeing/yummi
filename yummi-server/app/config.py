...
class Settings(BaseSettings):
    ...
    openai_recommendation_learning_exploration_model: str = Field(default="gpt-5-mini")
    openai_recommendation_learning_exploration_top_p: float | None = Field(default=None)
    openai_recommendation_learning_exploration_reasoning_effort: str = Field(default="low")
    openai_recommendation_learning_exploration_max_output_tokens: int = Field(default=1500)
    recommendation_learning_exploration_timeout_seconds: int = Field(default=25, ge=5, le=120)
    recommendation_learning_recommendation_candidate_limit: int = Field(default=100, gt=0, le=500)
    openai_recommendation_learning_model: str = Field(default="gpt-5-mini")
    openai_recommendation_learning_top_p: float | None = Field(default=None)
    openai_recommendation_learning_reasoning_effort: str = Field(default="low")
    openai_recommendation_learning_max_output_tokens: int = Field(default=10000)
    recommendation_learning_timeout_seconds: int = Field(default=45, ge=5, le=240)
    ...
    openai_shopping_list_max_output_tokens: int = Field(default=1500)
